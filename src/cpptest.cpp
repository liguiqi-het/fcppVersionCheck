...
// release buiid on------ ffix: release buiid on test ×
// release buiid on------ fix: release buiid on test √ V1.02
// release buiid on------ ffffix: release buiid on test × V1.02
// release buiid on------ ffix: release buiid on test × V1.02


// release buiid on------ fix: release buiid on test √ V1.02
// release buiid on------ ffix: release buiid on test × V1.03
// release buiid on------ fffix: release buiid on test × V1.03
// release buiid on------ fix: release buiid on test √ V1.02
// release buiid on------ fffix: release buiid on test × V1.03
// release buiid on------ ffix: release buiid on test × V1.03

// release buiid on------ fix: release buiid on test √ V1.05
// release buiid on------ ffix: release buiid on test × V1.05
// release buiid on------ fffix: release buiid on test × V1.05
// release buiid on------ docs: release buiid on test × V1.05

// release buiid on------ test: release buiid on test × V1.06
// release buiid on------ fix: release buiid on test × V1.06

// release buiid on------ test: release buiid on test × V1.07
...
// release buiid on------ fffix: release buiid on test × V1.11
// release buiid on------ feat: release buiid on test √ V1.20